...
// C/C++ source code generated on : Wed Oct 15 21:52:28 2025
//
...
#define ROS_SET_RTM_ERROR_STATUS(status) profacc_M->setErrorStatus(status)
#define ROS_GET_RTM_ERROR_STATUS()     profacc_M->getErrorStatus()
#define ROS_RTM_STEP_TASK(id)          profacc_M->StepTask(id)
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"profacc\" **\n");
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(ROS_GET_RTM_ERROR_STATUS()
                == (NULL)) || rtmGetStopRequested(profacc_M));
